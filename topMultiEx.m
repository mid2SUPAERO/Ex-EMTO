function [cO,xdensO,xcosO,xsinO,xcubO]=topMultiEx(nelx,nely,volfrac,initialDesign,problem)
...
fsum=1.0; %force value N
xMin = 0; %minimum cell density
xMax = 1; %maximum cell density


global B database sig; 
sig=0.04; %gaussian kernel radius
B = func_B();
load('ExDatabase63x125x34.mat'); % cell elastic tensor database
database=datbMat;
