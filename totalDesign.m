...
load('DB4stru1.mat') % microstructure database
load('DB4stru2.mat') % microstructure database
load('DB4stru3.mat') % microstructure database
load('DB4stru4.mat') % microstructure database
load('DB4stru5.mat') % microstructure database
